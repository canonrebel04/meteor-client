...
public class BaritoneSettings implements IPathManager.ISettings {
        ...
        private void createWrappers() {
                ...
                Class<? extends baritone.api.Settings> klass = BaritoneUtils.getSettings().getClass();
                ...
                for (Field field : klass.getDeclaredFields()) {
                        ...
                        Object obj;
                        try {
                                obj = field.get(BaritoneUtils.getSettings());
                        ...
                        Object value = BaritoneUtils.getSettingValue(setting);
                        ...
                        if (value instanceof Boolean) {
                                ...
                                Setting<Boolean> wrapper = sgBool.add(new BoolSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue((Boolean) BaritoneUtils.getSettingDefaultValue(s))
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                .onModuleActivated(bs -> bs
                                                                .set((Boolean) BaritoneUtils.getSettingValue(s)))
                                                .build());
                                wrapper.set((Boolean) BaritoneUtils.getSettingValue(s));
                                ...
                                sgDouble.add(new DoubleSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue((Double) BaritoneUtils.getSettingDefaultValue(s))
                                                .max(SETTING_MAX_VALUES.getOrDefault(field.getName(), 10.0))
                                                .sliderMax(SETTING_MAX_VALUES.getOrDefault(field.getName(), 10.0))
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                .onModuleActivated(
                                                                ds -> ds.set((Double) BaritoneUtils.getSettingValue(s)))
                                                .build());
                        } else if (value instanceof Float) {
                                baritone.api.Settings.Setting<Float> s = (baritone.api.Settings.Setting<Float>) setting;
                                sgDouble.add(new DoubleSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue(((Float) BaritoneUtils.getSettingDefaultValue(s))
                                                                .doubleValue())
                                                .max(SETTING_MAX_VALUES.getOrDefault(field.getName(), 10.0))
                                                .sliderMax(SETTING_MAX_VALUES.getOrDefault(field.getName(), 10.0))
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v.floatValue()))
                                                .onModuleActivated(
                                                                ds -> ds.set(((Float) BaritoneUtils.getSettingValue(s))
                                                                                .doubleValue()))
                                                .build());
                                ...
                                Setting<Integer> wrapper = sgInt.add(new IntSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue((Integer) BaritoneUtils.getSettingDefaultValue(s))
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                .onModuleActivated(is -> is
                                                                .set((Integer) BaritoneUtils.getSettingValue(s)))
                                                .build());
                                ...
                                if (wrapper.name.equals("maxFallHeightNoWater")) {
                                        noFall = new BoolSetting.Builder()
                                                        ...
                                                        .defaultValue(false)
                                                        .onChanged(aBoolean -> wrapper.set(
                                                                        aBoolean ? 159159 : wrapper.getDefaultValue()))
                                                        .onModuleActivated(booleanSetting -> booleanSetting
                                                                        .set(wrapper.get() >= 255))
                                                        .build();
                                }
                        } else if (value instanceof Long) {
                                baritone.api.Settings.Setting<Long> s = (baritone.api.Settings.Setting<Long>) setting;
                                sgInt.add(new IntSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue(((Long) BaritoneUtils.getSettingDefaultValue(s))
                                                                .intValue())
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v.longValue()))
                                                .onModuleActivated(is -> is.set(
                                                                ((Long) BaritoneUtils.getSettingValue(s)).intValue()))
                                                .build());
                        } else if (value instanceof String) {
                                baritone.api.Settings.Setting<String> s = (baritone.api.Settings.Setting<String>) setting;
                                sgString.add(new StringSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue((String) BaritoneUtils.getSettingDefaultValue(s))
                                                .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                .onModuleActivated(
                                                                ss -> ss.set((String) BaritoneUtils.getSettingValue(s)))
                                                .build());
                        } else if (value instanceof Color) {
                                baritone.api.Settings.Setting<Color> s = (baritone.api.Settings.Setting<Color>) setting;

                                Color def = (Color) BaritoneUtils.getSettingDefaultValue(s);

                                sgColor.add(new ColorSetting.Builder()
                                                .name(field.getName())
                                                .description(getDescription(field.getName()))
                                                .defaultValue(new SettingColor(def.getRed(), def.getGreen(),
                                                                def.getBlue(), def.getAlpha()))
                                                .onChanged(color -> BaritoneUtils.setSettingValue(s,
                                                                new Color(color.r, color.g, color.b, color.a)))
                                                .onModuleActivated(colorSetting -> {
                                                        Color curr = (Color) BaritoneUtils.getSettingValue(s);
                                                        colorSetting.set(new SettingColor(curr.getRed(),
                                                                        curr.getGreen(), curr.getBlue(),
                                                                        curr.getAlpha()));
                                                })
                                                .build());
                        } else if (value instanceof List) {
                                Type listType = ((ParameterizedType) field.getGenericType())
                                                .getActualTypeArguments()[0];
                                Type type = ((ParameterizedType) listType).getActualTypeArguments()[0];

                                if (type == Block.class) {
                                        baritone.api.Settings.Setting<List<Block>> s = (baritone.api.Settings.Setting<List<Block>>) setting;
                                        sgBlockLists.add(new BlockListSetting.Builder()
                                                        .name(field.getName())
                                                        .description(getDescription(field.getName()))
                                                        .defaultValue((List<Block>) BaritoneUtils
                                                                        .getSettingDefaultValue(s))
                                                        .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                        .onModuleActivated(
                                                                        bls -> bls.set((List<Block>) BaritoneUtils
                                                                                        .getSettingValue(s)))
                                                        .build());
                                } else if (type == Item.class) {
                                        baritone.api.Settings.Setting<List<Item>> s = (baritone.api.Settings.Setting<List<Item>>) setting;
                                        sgItemLists.add(new ItemListSetting.Builder()
                                                        .name(field.getName())
                                                        .description(getDescription(field.getName()))
                                                        .defaultValue((List<Item>) BaritoneUtils
                                                                        .getSettingDefaultValue(s))
                                                        .onChanged(v -> BaritoneUtils.setSettingValue(s, v))
                                                        .onModuleActivated(ils -> ils.set(
                                                                        (List<Item>) BaritoneUtils.getSettingValue(s)))
                                                        .build());
                                }
                        }
                }
        ...
        private static void loadDescriptions() {
                ...
                addDescription("allowJumpAt256",
                                "If true, parkour is allowed to make jumps when standing on blocks at the maximum height, so player feet is y=256");
                addDescription("allowOnlyExposedOres",
                                "This will only allow baritone to mine exposed ores, can be used to stop ore obfuscators on servers that use them.");
                addDescription("allowOnlyExposedOresDistance",
                                "When allowOnlyExposedOres is enabled this is the distance around to search.");
                addDescription("allowOvershootDiagonalDescend",
                ...
                addDescription("allowWalkOnBottomSlab",
                                "Slab behavior is complicated, disable this for higher path reliability.");
                addDescription("allowWaterBucketFall",
                                "Allow Baritone to fall arbitrary distances and place a water bucket beneath it.");
                addDescription("antiCheatCompatibility",
                                "Will cause some minor behavioral differences to ensure that Baritone works on anticheats.");
                addDescription("assumeExternalAutoTool",
                                "Disable baritone's auto-tool at runtime, but still assume that another mod will provide auto tool functionality");
                addDescription("assumeSafeWalk",
                ...
                addDescription("avoidBreakingMultiplier",
                                "this multiplies the break speed, if set above 1 it's \"encourage breaking\" instead");
                addDescription("avoidUpdatingFallingBlocks",
                                "If this setting is true, Baritone will never break a block that is adjacent to an unsupported falling block.");
                addDescription("axisHeight",
                ...
                addDescription("blacklistClosestOnFailure",
                ...
                addDescription("blocksToAvoidBreaking",
                ...
                addDescription("breakCorrectBlockPenaltyMultiplier",
                ...
                addDescription("buildValidSubstitutes",
                                "A mapping of blocks to blocks treated as correct in their position.");
                addDescription("cachedChunksExpirySeconds",
                ...
                addDescription("chatControlAnyway",
                ...
                addDescription("considerPotionEffects",
                                "For example, if you have Mining Fatigue or Haste, adjust the costs of breaking blocks accordingly.");
                addDescription("costHeuristic", "This is the big A* setting.");
                addDescription("costVerificationLookahead",
                                "Stop 5 movements before anything that made the path COST_INF.");
                addDescription("cutoffAtLoadBoundary",
                ...
                addDescription("disableCompletionCheck",
                ...
                addDescription("internalMiningAirException",
                ...
                addDescription("legitMineIncludeDiagonals",
                ...
                addDescription("maxFallHeightBucket",
                ...
                addDescription("mineScanDroppedItems",
                                "While mining, should it also consider dropped items of the correct type as a pathing destination (as well as ore blocks)?");
                addDescription("minimumImprovementRepropagation",
                                "Don't repropagate cost improvements below 0.01 ticks.");
                addDescription("minYLevelWhileMining",
                ...
                addDescription("movementTimeoutTicks",
                ...
                addDescription("pathingMapLoadFactor",
                                "Load factor coefficient for the Long2ObjectOpenHashMap used in pathing");
                addDescription("pathingMaxChunkBorderFetch",
                ...
                addDescription("renderGoalAnimated",
                ...
                addDescription("renderSelectionBoxesIgnoreDepth",
                ...
                addDescription("repackOnAnyBlockChange",
                                "Whenever a block changes, repack the whole chunk that it's in");
                addDescription("replantCrops",
                ...
                addDescription("rightClickContainerOnArrival",
                ...
                addDescription("shortBaritonePrefix",
                                "Use a short Baritone prefix [B] instead of [Baritone] when logging to chat");
                addDescription("simplifyUnloadedYCoord",
                ...
                addDescription("verboseCommandExceptions",
                ...
                addDescription("walkWhileBreaking",
                                "Don't stop walking forward when you need to break blocks in your way");
                addDescription("worldExploringChunkOffset",
                                "While exploring the world, offset the closest unloaded chunk by this much in both axes.");
                addDescription("yLevelBoxSize",
